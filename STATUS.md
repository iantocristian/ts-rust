...
| Run | State | Artifact |
|---|---|---|
| clippy | current | [result](status/evidence/5ada6f0f8d18655e38267579062288bccc78c0bd5d3034b174c1a45fdf9510ca.json) |
| deny | current | [result](status/evidence/c50858942f469fc03f0e064571fcd0943b922938f62e9cb426b3ea46181c851f.json) |
| fmt | current | [result](status/evidence/5cab97bafd1e097acf0cbec2c0fde0830a611220afd06a890676a712c760914d.json) |
| oracle | current | [result](status/evidence/0bacdee0dde3cad89582c45bf433cd52730b991c5d803402e0b56d2c14019a46.json) |
| selftest | current | [result](status/evidence/80f1af1b3e9f8925ac6ffb998678a56b5ede9064a675e5c4d1644e7bbd4e9bd9.json) |
| workspace | current | [result](status/evidence/1c68dd6c753a1c440fc33287377b3b9d89a9298f9c9549e1eeb1fd5c39c06292.json) |
...
- [-] S02-4 Status workflow on macOS and Linux: validate provenance, check the committed views, rerun producers, check S01, publish views and evidence as artifacts (verified on GitHub, not in the ledger) [optional]
...
- [ ] `exp.E4.helper_printer_semantics.pass == 1`
...
- [ ] `exp.E4.token_literal_bytes.pass == 1`
...
ts_parser, the ts_ast runtime and ts_encoder at protocol 8 parse and encode the frozen corpus and the lib files identically to the Go oracle; E1 and E4 pass.
