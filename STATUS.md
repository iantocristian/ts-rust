...
| Mapped upstream functions | 1695 of 11506 (14.7%) |
| Experiments passed | 0 of 8 |
| ADRs accepted | 18 of 20 |
...
| E2: Checker slice | frozen_subset | `run.e2.frozen_subset == true` the checked-in subset rule, manifest, options and exclusions match the committed denominator; no skipped cases (PLAN.md, section 13, item 16) | missing | pending |
...
| E5: Memory | peak_rss | `run.e5.peak_rss_ratio <= 0.7` Rust / Go peak RSS for parse and bind of the pinned VS Code workload | 0.7350523227129911 | fail |
| E5: Memory | allocated_bytes | `run.e5.allocated_bytes_ratio <= 0.7` Rust / Go bytes allocated for the same parse/bind workload | 0.7716601584975543 | fail |
...
| E6: CPU | one_thread | `run.e6.one_thread_wall_time_ratio <= 1` Rust / Go wall time at one thread | 1.277304475133057 | fail |
| E6: CPU | eight_threads | `run.e6.eight_threads_wall_time_ratio <= 1` Rust / Go wall time at eight threads | 1.42036258069849 | fail |
...
| Run | State | Artifact |
|---|---|---|
| binder | stale: source, pin, command or inputs changed | [result](status/evidence/565fc34baed6c5e2f263e35aa89d77eb2347c821505a71ae6f0de32b0ef6a135.json) |
| bindworkload | current | [result](status/evidence/86651e2b7aab76b5cfeea9b1e42ed92d540ee9d2dd439ad55a7dfa566d1dd305.json) |
...
| e3 | stale: source, pin, command or inputs changed | [result](status/evidence/162878622bd056fea3130d3fd4e7c50c40c6f174df424df0f02796ccf7803882.json) |
...
| e5 | current | [result](status/evidence/db8056ff57887bd1014878cad024e52e2ba8731b9ea3275d9ecddc02aa49e099.json) |
| e6 | current | [result](status/evidence/b9e13035971f0c440ad5733644fa85df18f55b9298251168cf968983bb5dc0e2.json) |
...
| program | stale: source, pin, command or inputs changed | [result](status/evidence/cbaa73b694df7a0ef5e45bbf9436cc826c8ff5bb5b80fc22adb3a63e092ff699.json) |
| scanner | stale: source, pin, command or inputs changed | [result](status/evidence/961736031f4dab6c34a5674c7d161668387b6f586b1bd27e5953426983a3c23a.json) |
| selftest | stale: source, pin, command or inputs changed | [result](status/evidence/e26914a4a255013b20f909f3f7b455e4a6b53d3046677ba48432cb6b0c22e1da.json) |
| workspace | stale: source, pin, command or inputs changed | [result](status/evidence/1f6fa21971fc0d90a9713abcbae3b96d0134df0f3525c7877f39298e9d6cfe7e.json) |
