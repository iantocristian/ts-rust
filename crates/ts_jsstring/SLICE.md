...
Position APIs live in `positions`; they retain the separate API, LSP and scanner
rules for malformed bytes, surrogate sentinels, partial offsets and line maps.
