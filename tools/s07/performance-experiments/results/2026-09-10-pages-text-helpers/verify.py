...
BOOTSTRAP = (
    "target/s07-bis/pages-text-helpers-archive/archive.py",
    "target/s07-bis/pages-text-helpers-archive/archive_helpers.py",
)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, required=True,
                        help="Fresh directory for the unchanged archive replay and all eight validators")
